    ...
    <div id="expertise" className={clsx(className)}>
      ...
      <div className="grid grid-cols-1 gap-5 xl:grid-cols-2">
        <Card>
          ...
          <CardContent>
            <p>
              With over 7 years of experience, I specialize in crafting seamless
              and interactive user interfaces using modern frontend
            ...
            <ul>
              <li>
                ...
                <span className="text-accent"> Angular</span>, ensuring dynamic
          ...
          <CardContent>
            ...
            <ul>
              <li>
                ...
                : Experienced with <span className="text-accent">Node.js</span>{" "}
                and
                <span className="text-accent">Spring</span>, enabling robust and
